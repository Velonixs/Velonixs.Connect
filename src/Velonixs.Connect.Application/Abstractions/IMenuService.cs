...
public interface IMenuService
{
    ...
    Task<MenuItemResponse?> GetItemAsync(Guid id, CancellationToken cancellationToken = default);
    Task<MenuItemResponse?> UpdateItemAvailabilityAsync(Guid id, bool isAvailable, CancellationToken cancellationToken = default);
